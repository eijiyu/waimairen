<?php /* Smarty version Smarty-3.1.10, created on 2016-08-25 16:49:31
         compiled from "/data/wwwroot/waimairen/templates/m7/shopcenter/shoporderlist.html" */ ?>
<?php /*%%SmartyHeaderCode:38562283757beb11b8f80b5-92505285%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a5ab9805b7f1293aca038bcdc9cf44121544b2aa' => 
    array (
      0 => '/data/wwwroot/waimairen/templates/m7/shopcenter/shoporderlist.html',
      1 => 1452852368,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '38562283757beb11b8f80b5-92505285',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57beb11bbcf426_68318435',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57beb11bbcf426_68318435')) {function content_57beb11bbcf426_68318435($_smarty_tpl) {?><?php if (!is_callable('smarty_function_load_data')) include '/data/wwwroot/waimairen/lib/Smarty/libs/plugins/function.load_data.php';
					...
					<?php if ($_smarty_tpl->tpl_vars['items']->value['is_reback']==0){?>
						<?php if ($_smarty_tpl->tpl_vars['items']->value['paytype']==1){?>
							   ...
							   <?php }elseif($_smarty_tpl->tpl_vars['items']->value['is_make']==1){?>
								...
								<?php }?>	
						<?php }else{ ?>
							<?php if ($_smarty_tpl->tpl_vars['items']->value['is_make']==0){?> 待商家确认 <?php }?>	
							
							<?php if ($_smarty_tpl->tpl_vars['items']->value['is_make']>0){?>
								<?php echo $_smarty_tpl->tpl_vars['buyerstatus']->value[$_smarty_tpl->tpl_vars['items']->value['status']];?>

								<?php if ($_smarty_tpl->tpl_vars['items']->value['status']>1){?>
								<?php if ($_smarty_tpl->tpl_vars['items']->value['is_acceptorder']==1){?>，用户已确认收货<?php }else{ ?>，用户未确认收货<?php }?>
								<?php }?>
						   <?php }?>	
						<?php }?>
					<?php }else{ ?>
						<font color=red><?php echo $_smarty_tpl->tpl_vars['backarray']->value[$_smarty_tpl->tpl_vars['items']->value['is_reback']];?>
</font>
					<?php }?>
          	<?php }?>
