<?php /* Smarty version Smarty-3.1.10, created on 2016-08-25 16:33:45
         compiled from "/data/wwwroot/waimairen/templates/m7/site/index.html" */ ?>
<?php /*%%SmartyHeaderCode:45400697157bead69360db6-19939319%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1dae82733b7cfe5a0acf16d21a0b974f3803ec89' => 
    array (
      0 => '/data/wwwroot/waimairen/templates/m7/site/index.html',
      1 => 1453098078,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '45400697157bead69360db6-19939319',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57bead69550284_00186875',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57bead69550284_00186875')) {function content_57bead69550284_00186875($_smarty_tpl) {?><?php if (!is_callable('smarty_function_load_data')) include '/data/wwwroot/waimairen/lib/Smarty/libs/plugins/function.load_data.php';
...
/index.php?ctrl=site&action=index"+newstr;
    ...
    MT.STATIC_ROOT = "http://xs01.meituan.net/waimai_web/55669089";
    MT.ENV = "production";
    </script>	
...
出售<?php echo $_smarty_tpl->tpl_vars['items']->value['sellcount'];?>
单
  	              </span>
  		          </div>
              <div class="price">
...
?>
									             <?php if ($_smarty_tpl->tpl_vars['itcc']->value['parent_id']==$_smarty_tpl->tpl_vars['itaa']->value['firstattr']){?>
									                 <?php echo (($tmp = @$_smarty_tpl->tpl_vars['itaa']->value['value'])===null||$tmp==='' ? '未说明' : $tmp);?>
